...
{
    public class JobBatchValidationAssemblage : JobBatchValidationManager, IJobBatchValidationManager
    {
        public JobBatchValidationAssemblage(CustomScriptManager csm) : base(csm) { }
        protected override void SetJobBatchJobNum()
        {
            jobBatchJobNum = GetJobFictiveForType("Hydro");
        }
        public string JobBatchTitle { get { return "Validation JobBatch Assemblage"; } }
